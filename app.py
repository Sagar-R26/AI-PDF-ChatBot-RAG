...
<style>
    ...
    .source-doc strong, .source-doc em {
        color: #1e1e1e;
    }
    .success-message {
...
<div class="main-header">
    ...
    <p>PDF question-answering with retrieval-augmented generation</p>
</div>
""", unsafe_allow_html=True)
...
ollama serve
    ...
    with st.expander("Advanced Settings", expanded=False):
        ...
        max_workers = st.slider("Max Workers", 1, 16, min(8, os.cpu_count() or 4), step=1)
